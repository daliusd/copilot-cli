...
`,
        ...
        parameters: {
          ...
          properties: {
            ...
            mode: {
              ...
              description:
                'Edit mode: "add" inserts new content before startLine, "update" replaces content between startLine and endLine, "delete" removes content between startLine and endLine.',
            },
            startLine: {
              type: 'number',
            ...
            endLine: {
              type: 'number',
              description: 'Ending line number for the edit (inclusive). Required for "update" and "delete" modes.',
            },
            code: {
              type: 'string',
              description: 'New content for the edit operation. Required for "add" and "update" modes.',
            },
          },
        },
    ...
    execute: async (params) => {
      try {
        ...
        const { mode, startLine, endLine, code } = params;
        ...
        switch (mode) {
          case 'add':
            ...
            break;
          case 'update':
            if (endLine === undefined || endLine === null || !code) {
              throw new Error('End line and code content are required for update action');
            }
            lines.splice(startIdx, endLine - startLine + 1, ...code.split('\n'));
            break;
          case 'delete':
